...
public class OneToOneChatFollowersHelper {

	public OneToOneChatFollowersHelper(WebDriver driver) {
	...
	@FindBy(xpath = "//h5[contains(text(),'Followers (1)')]")
	public WebElement FollowersHeadingWithCount;
	
	@FindBy(xpath = "//li[contains(@class,'contact-groupsamelist contact follower-item replies-list')]//div[contains(@class,'wrap chat-panel open-chat')]//div//img[contains(@class,'ng-lazyloaded')]")
	public WebElement FollowerProfilePic;
	
	@FindBy(xpath = "//div[contains(@class,'col-12 name')]")
	public WebElement FollowerName;
	
	@FindBy(xpath = "//li[contains(@class,'contact-groupsamelist contact follower-item replies-list')]//div[contains(@class,'wrap chat-panel open-chat')]//div//span[contains(@class,'contact-status online')]")
	public WebElement FollowerOfflineStatus;
	
	@FindBy(xpath = "//i[contains(@class,'greet-user-first-logo')]")
	public WebElement ConversationDefaultIcon;
	
	@FindBy(xpath = "//div[contains(text(),'Start a new conversation')]")
	public WebElement ConversationScreenDefaultText;
